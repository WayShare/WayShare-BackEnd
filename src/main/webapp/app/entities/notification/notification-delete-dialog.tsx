...
export const NotificationDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="wayShareApp.notification.delete.question">
        <Translate contentKey="wayShareApp.notification.delete.question" interpolate={{ id: notificationEntity.id }}>
