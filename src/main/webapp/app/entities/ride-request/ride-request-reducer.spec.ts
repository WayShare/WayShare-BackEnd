...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_RIDEREQUEST_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_RIDEREQUEST actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_RIDEREQUEST actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_RIDEREQUEST actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_RIDEREQUEST actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_RIDEREQUEST actions', async () => {
      const arg = 42666;
